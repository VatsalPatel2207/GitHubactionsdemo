<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="make-direction-2.aspx.cs" Inherits="MyMapSolution.make_direction_2" %>
...
<head runat="server">
    ...
    <script type='text/javascript'>
        ...
        function GetMap() {
            ...
            Microsoft.Maps.loadModule(['Microsoft.Maps.Directions', 'Microsoft.Maps.SpatialMath'], function () {
                ...
                for (var i = 0; i < MyAddressObj.length; i++) {
                    ...
                    var location = new Microsoft.Maps.Directions.Waypoint({ location: new Microsoft.Maps.Location(MyAddressObj[i][2], MyAddressObj[i][3]) });
        ...
        function NewTest(route) {
            var pushpin = new Microsoft.Maps.Pushpin(new Microsoft.Maps.Location(23.062266, 72.497202));
            var polyline = new Microsoft.Maps.Polyline([
                ...
                new Microsoft.Maps.Location(23.075973, 72.564694),
                new Microsoft.Maps.Location(23.07635, 72.56677),
                new Microsoft.Maps.Location(23.080059, 72.5685),
                new Microsoft.Maps.Location(23.07957, 72.574411),
                new Microsoft.Maps.Location(23.079101, 72.575613),
                new Microsoft.Maps.Location(23.078148, 72.575709)], { strokeColor: 'red', strokeThickness: 5 });
            var layer = new Microsoft.Maps.Layer();
            layer.add([pushpin, polyline]);
            map.layers.insert(layer);
        }
