<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="make-direction-current-location.aspx.cs" Inherits="MyMapSolution.make_direction_current_location" %>
...
<head runat="server">
    ...
    <script type='text/javascript'>
        ...
        function GetDistanceByAddress(LocationAddress) {
            ...
            item1[1] = GeoPoint[0];
            item1[2] = GeoPoint[1];
            item1[3] = Math.round(DistanceMile, 0);
        ...
        function StartJourney() {
            ...
            Microsoft.Maps.loadModule('Microsoft.Maps.Directions', function () {
                ...
                for (var i = 0; i < MyAddressObj.length; i++) {
                    ...
                    var waypoint1 = new Microsoft.Maps.Directions.Waypoint({ address: Address, location: new Microsoft.Maps.Location(latitude, longitude) });
                    directionsManager.addWaypoint(waypoint1);

                    if (i > 0) {
                        var Status = "Pending";

                        /* if (CompleteAnyJourneyStatus == 0) {*/
