<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-map-2.aspx.cs" Inherits="MyMapSolution.final_map_2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Final Page With Location Point Color Change</title>
    <meta charset="utf-8" />
    ...
    <script type="text/javascript">
        ...
        var MyKey = "Aj0QaseEPBN2VnIZFY8FRwqQrOiXDKPgEQuO3aH1KcoDJLdgwEpSwt3Ikxj-OYsc"; // Dynatech
        //var MyKey = "ApkcSkqznfLOnqrZqu1yQtHRpJbCLveCpcNTzgL8ovKp7jaTGfXVc-S7qIpwMuVO"; // Personal
        ...
        function getRoute(addresses, Status) {
            ...
            for (var i = 0; i < addresses.length; i++) {
                ...
                if (i > 0) {
                    if (JourneyStatus == "Pending") {
                        JourneyDetail(i, StartLocation, Address, Distance, "Pending");
                    }
                }
